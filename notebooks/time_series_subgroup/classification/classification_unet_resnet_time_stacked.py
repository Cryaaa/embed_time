...
latent_spaces = {
    ...
    # "Resnet18_Convolutional_26000z_Old_Normalisation":pd.read_csv(
    #     Path(tabular_data)/"Resnet18_VAE_03_old_normalisation.csv"
    # ),
    # "Resnet18_Convolutional_26000z_New_Normalisation":pd.read_csv(
    #     Path(tabular_data)/"Resnet18_VAE_04_new_normalisation.csv"
    # ),
    "Resnet18_Linear_50z_New_Normalisation":pd.read_csv(
        Path(tabular_data)/"LinearVAE_01_bicubic_latents_w_annot.csv"
    ),
    "Resnet18_Linear_100z_New_Normalisation":pd.read_csv(
...
plt.savefig(Path(tabular_data) / "Morph Prediction.pdf", format="pdf", bbox_inches="tight")
plt.show()
